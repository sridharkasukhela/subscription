...
import { deleteEntity, getEntity } from './user.reducer';
...
export const UserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="subscriptionApp.user.delete.question">
        <Translate contentKey="subscriptionApp.user.delete.question" interpolate={{ id: userEntity.id }}>
