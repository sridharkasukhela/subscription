...
import static my.projects.datastore.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static my.projects.datastore.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static my.projects.datastore.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import my.projects.datastore.IntegrationTest;
import my.projects.datastore.security.AuthoritiesConstants;
